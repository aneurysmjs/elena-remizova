...
import reactLogo from '~/assets/img/brands/react-logo.png';
import tailwindLogo from '~/assets/img/brands/tailwind-logo.png';
import firebaseLogo from '~/assets/img/brands/firebase-logo.png';
